...
df = pd.read_excel(r'https://firebasestorage.googleapis.com/v0/b/testbot-817dd.appspot.com/o/DatasetFinale%20(1)%20(3)%20(1).xlsx?alt=media&token=96894781-d25e-40cb-9cc5-9852de33d7a4')
...
def webhook():
    ...
    if (query_result.get('action') == 'input.welcome'):
        ...
        if(key=="None"):
            ...
            #db.child("utenti").child(chat_id).child("PosizioneInLista").set(indice)
